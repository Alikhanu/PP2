...
ЗНМ: SWK00034961
WEBKASSA.KZ'''
words_to_check = txt.split()

#Exercis1----------------------------------------------------
def match_zero_more_b(word):
...
print("Words with zero or more b after a:")
for word in words_to_check:
    if match_zero_more_b(word):
        print(word)
#Exercis2----------------------------------------------------
def match_two_three_b(word):
    pattern = re.compile('abb.')
    pattern_1 = re.compile('abbb.')
    if pattern.match(word) or pattern_1.match(word):
        return True
    else:
        return False

print("Words with two or three b after a:")
for word in words_to_check:
    if match_two_three_b(word):
        print(word)
#Exercis3----------------------------------------------------
